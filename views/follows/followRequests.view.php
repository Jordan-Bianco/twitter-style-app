...
<div class="text-xs">
    <div class="flex items-center space-x-2 mb-4">
        <svg class="w-[18px] h-[18px] text-lime-500" fill=" currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    ...
    <?php foreach ($followRequests as $request) : ?>
        <div class="panel mb-3">
            <p class="mb-2"><a href="/<?= $request['username'] ?>" class="text-lime-500"><?= $request['username'] ?></a> requested to follow you</p>
