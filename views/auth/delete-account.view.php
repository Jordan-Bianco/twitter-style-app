...
$this->title .= ' - Cancella account';
?>

<div class="max-w-[350px] mx-auto mt-10">
    <section class="p-6 border border-zinc-700 shadow-md shadow-zinc-900 rounded-lg">
        <h2 class="text-center text-3xl font-medium mb-2.5">Cancella account</h2>
        <p class="text-center text-zinc-400 text-xs mb-6">Inserisci il tuo indirizzo email per cancellare il tuo account.</p>
        ...
        <form action="/delete-account" method="POST">
            <div class="mb-5">
                ...
                <input name="email" placeholder="Inserisci la tua email" type="email" class="w-full text-xs px-4 py-3 bg-zinc-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-zinc-700 transition">
            </div>
