...
<div class="max-w-[350px] mx-auto mt-10">
    <section class="p-6 border border-zinc-700 shadow-md shadow-zinc-900 rounded-lg">
        ...
        <p class="text-center text-xs text-zinc-400 mb-6">Non sei ancora iscritto?
            <span class="text-lime-500"><a href="/register">Registrati</a></span>
        </p>
        ...
        <form action="login" method="POST">
            ...
            <a class="block text-xs text-zinc-400 hover:underline mb-8" href="/forgot-password">Password dimenticata?</a>
