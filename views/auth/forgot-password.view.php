...
<div class="max-w-[350px] mx-auto mt-10">
    <section class="p-6 border border-zinc-700 shadow-md shadow-zinc-900 rounded-lg">
        ...
        <p class="text-center text-zinc-400 text-xs mb-6">Inserisci il tuo indirizzo email, ti verrà inviata una mail contenente un link per resettare la password.</p>
